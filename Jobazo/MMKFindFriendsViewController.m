//
//  MMKFindFriendsViewController.m
//  Jobazo
//
...
@implementation MMKFindFriendsViewController
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (FBSession.activeSession.isOpen) {
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Log In with Facebook"
                              ...
                              @"friends' activity within Jobazo, and "
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    switch (buttonIndex) {
        ...
        case 1: { // log in
            ...
            __block MMKFindFriendsViewController *me = self;
